...
import com.example.login.demoLogin.email.EmailSender;
import com.example.login.demoLogin.registration.token.ConfirmationToken;
import com.example.login.demoLogin.registration.token.ConfirmationTokenService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        emailSender.send(
                request.getEmail(),
                buildEmail(request.getFirsName(), link));
